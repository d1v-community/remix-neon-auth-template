export function DevLoadingCard() {
  return (
    <div className="w-full max-w-xl rounded-2xl border border-slate-200 bg-white/80 p-6 shadow-xl shadow-slate-200/60 backdrop-blur dark:border-slate-800 dark:bg-slate-950/90 dark:shadow-slate-950/40">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-slate-400">
            First bricks are going in. The world is being built.
          </span>
        </div>
      ...
      <div className="relative overflow-hidden rounded-xl border border-slate-200 bg-slate-50 px-4 py-6 dark:border-slate-800 dark:bg-slate-950/80">
        <svg
          ...
          role="img"
          aria-label="Hello world environment under construction"
        >
          <defs>
          ...
          {/* hello world label as blueprint text */}
          <g>
            <rect
              x="176"
              y="40"
      ...
      <div className="mt-3 text-xs text-slate-500 dark:text-slate-400">
        Every "hello world" is a small construction site: beams, cranes, and the first bricks of a new world.
      </div>
    </div>
  );
}
